...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white text-[#1A1A1A] font-sans overflow-x-hidden">
      ...
      <section className="pt-32 pb-24 md:py-36 bg-gradient-to-b from-gray-50 to-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative w-full aspect-[4/3] lg:aspect-square max-w-lg mx-auto bg-gray-50 rounded-[3rem] border border-gray-100 p-8 flex items-center justify-center shadow-inner">
              ...
              <div className="relative w-full h-full flex flex-col justify-between p-6">
                <svg className="absolute inset-0 w-full h-full p-6" viewBox="0 0 400 400" fill="none">
                  ...
                  <path d="M 80 320 C 120 200, 280 200, 320 80" stroke="#0B8F63" strokeWidth="4" strokeLinecap="round" strokeDasharray="8 8" />
                ...
                <div className="absolute top-12 left-6 bg-white border border-gray-100/80 rounded-2xl p-4 shadow-[0_15px_30px_rgba(0,0,0,0.06)] flex items-center gap-3.5 z-10 w-64">
                ...
                <div className="absolute bottom-12 right-6 bg-white border border-gray-100/80 rounded-2xl p-4 shadow-[0_15px_30px_rgba(0,0,0,0.06)] flex items-center gap-3.5 z-10 w-64">
      ...
      <section id="como-funciona" className="py-24 bg-white border-y border-gray-50 scroll-mt-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            {/* Benefit 1 */}
            <div className="bg-white border border-gray-100 rounded-[2rem] p-6 shadow-[0_10px_30px_rgba(0,0,0,0.02)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.05)] transition-all duration-300 flex flex-col justify-between">
      ...
      {/* 4. SECCIÓN CTA FINAL */}
      <section className="py-24 bg-gray-50 flex flex-col items-center justify-center">
      ...
      {/* 5. FOOTER */}
      <footer id="contacto" className="bg-white border-t border-gray-100 pt-16 pb-12">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 pb-12 border-b border-gray-100">
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <div className="flex gap-3">
                <a href="#" className="w-9 h-9 rounded-full bg-gray-50 flex items-center justify-center text-gray-400 hover:text-[#0B8F63] hover:bg-[#DFF7EC] transition-all shadow-2xs">
            ...
            <div className="lg:col-span-8 grid grid-cols-2 sm:grid-cols-3 gap-8">
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2.5 text-sm">
                  <li>
                    <Link href="#como-funciona" className="text-gray-600 hover:text-[#0B8F63] transition-colors cursor-pointer">
                      Cómo funciona
                    </Link>
                  </li>
                  <li>
                    <Link href="/login" className="text-gray-600 hover:text-[#0B8F63] transition-colors cursor-pointer">
                      Buscar un viaje
                    </Link>
                  </li>
                  <li>
                    <Link href="/registro/conductor" className="text-gray-600 hover:text-[#0B8F63] transition-colors cursor-pointer">
                      Ser conductor
                    </Link>
                  </li>
                  <li>
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2.5 text-sm">
                  ...
                  <li>
                    <Link href="#" className="text-gray-600 hover:text-[#0B8F63] transition-colors cursor-pointer">
                      Blog
                    </Link>
                  </li>
                  <li>
                    <Link href="#contacto" className="text-gray-600 hover:text-[#0B8F63] transition-colors cursor-pointer">
                      Contacto
                    </Link>
                  </li>
                </ul>
